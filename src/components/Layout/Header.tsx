    ...
    <nav className='bg-black border-gray-200 lg:px-8 px-4 lg:py-6 md:py-4 py-1'>
      <div className='container flex flex-wrap justify-between items-center'>
        ...
        <button
          ...
          type='button'
          className='inline-flex items-center p-2 mb-0.5 ml-3 text-sm text-white rounded-lg md:hidden hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200'
