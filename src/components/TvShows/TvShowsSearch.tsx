...
export default function TvShowsSearch({handleFiltersChange}:PropsSearch) {
  ...
  const yearsFilter = [2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 
    2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022];

  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await interceptorAxios.get<ResponseGenres, ResponseGenres>(`${BASE_URL}genre/tv/list`);
  ...
  return (
    <div className='flex justify-center items-start sm:flex-row flex-col py-4 px-4'>
      ...
      <select name='searchTvShowsByYear' id='searchTvShowsByYear' className='p-2 bg-white border border-black sm:w-auto w-full' onChange={handleFiltersChange}>
